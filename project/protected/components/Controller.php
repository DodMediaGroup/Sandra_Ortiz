...
class Controller extends CController
{
	...
	public $pageTitle = 'Sandra Ortiz';
	public $pageDescription = 'NUESTRA GESTIÓN ES UNA REALIDAD. Comprometida con las causas sociales y el mejoramiento de la calidad de vida de las personas.';
