...
class MyMethods extends CApplicationComponent
{
	...
	public static function sentMail($subject, $from, $to, $content, $options=array()){
		$fromName = (isset($options['fromName']))?$options['fromName']:'Kogui';
		...
		$body = '<table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;background:#9096a5;min-width:620px;table-layout:fixed;">'.
			...
			$content.'<br>'.
			'Enviado desde sitio web Kogui<br><br>'.
			'</div></td></tr>'.
			'<tr><td align="center" style="background-color:#eeeeee; color:#444444; font-size:10px; padding-top:5px; padding-bottom:5px;">Derechos reservados Kogui</td></tr>'.
	...
	public static function uploadFile($file,$path){
		...
		$nameImage = MyMethods::normalizarUrl($nameImage[0]).rand(111, 999).'.'.$nameImage[1];
