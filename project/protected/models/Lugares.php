 ...
 * @property ContactoPersonas[] $contactoPersonases
...
class Lugares extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('tipo, depende, estado', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			'contactoPersonases' => array(self::HAS_MANY, 'ContactoPersonas', 'ciudad'),
