...
?>
  ...
  <div style="margin-top: -30px" class="content row">
    <div class="col-xs-12 col-lg-8">
      ...
      <div class="section-image-ley"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/debates/<?php echo $model->imagen; ?>"/></div>
      ...
      <div class="row">
        ...
        <div class="col-xs-12"><a href="<?php echo $this->createUrl('/debates_control_politico'); ?>">
