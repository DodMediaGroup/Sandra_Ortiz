						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								<?php echo $form->labelEx($model,'categoria'); ?>
		        				 <?php echo $form->dropDownList($model,'categoria', MyMethods::getListSelect('PublicacionesCategorias', 'id', 'nombre'), array('class'=>'form-control')); ?>
							</div>
							...
							<div class="form-group">
								<div class="imag-before-upload" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/admin/gray.jpg); max-width: 180px;">
									<?php if(!$model->isNewRecord && $model->imagen != ""){ ?>
										<div class="img" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/publicaciones/<?php echo $model->imagen; ?>)"></div>
									<?php } ?>
								</div>
