	...
	<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								<?php echo $form->labelEx($model,'categoria'); ?>
		        				 <?php echo $form->dropDownList($model,'categoria', MyMethods::getListSelect('ProyectosCategorias', 'id', 'nombre'), array('class'=>'form-control')); ?>
							</div>
							...
							<div class="form-group">
								<?php echo $form->labelEx($model,'es_emblematico'); ?>
		        				<div>
		        					<?php echo $form->checkBox($model,'es_emblematico',array('class'=>'ios-switch ios-switch-success ios-switch-sm')); ?>
		        				</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<div class="imag-before-upload" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/admin/gray.jpg); max-width: 180px;">
									<?php if(!$model->isNewRecord && $model->imagen != ""){ ?>
										<div class="img" style="background-image: url(<?php echo Yii::app()->request->baseUrl; ?>/images/proyectos/<?php echo $model->imagen; ?>)"></div>
									<?php } ?>
								</div>
		...
		<div class="col-sm-12">
			<div class="form-group">
                ...
                <a href="<?php echo $this->createUrl('proyectos/admin'); ?>" class="btn btn-danger">Cancelar</a>
			</div>
		</div>
	</div>
<?php $this->endWidget(); ?>