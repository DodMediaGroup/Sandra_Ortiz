...
class RendicioncuentasController extends Controller
{
    ...
    public function actionAdmin()
    {
        ...
        $cuentas = RendicionCuentas::model()->findAll(array('condition'=>'t.estado != 2', 'order'=>'t.id DESC'));
    ...
    public function actionCreate()
    {
        ...
        $model=new RendicionCuentas;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if(isset($_POST['RendicionCuentas']))
        {
            $errors = false;
            $model->attributes=$_POST['RendicionCuentas'];
            $model->clearErrors();
     ...
     */
    public function actionDelete_rendicion($id)
    {
        $rendicion = $this->loadModel($id);
    ...
    {
        $model=RendicionCuentas::model()->findByAttributes(array('id'=>$id), array('condition'=>'t.estado != 2'));
        if($model===null)
            throw new CHttpException(404,'The requested page does not exist.');
        return $model;
    }
